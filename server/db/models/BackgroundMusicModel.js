...
export class BackgroundMusicModel extends BaseModel {
  static table = 'background_music';
  ...
  static indexes = [
    { name: 'background_music_filename_unique', columns: ['filename'], unique: true },
    { name: 'background_music_mode_idx', columns: ['mode'] },
  ];
